...
<head>
    ...
    <meta name="description"
        content="ศูนย์กลางข่าวสาร กิจกรรม ปฏิทิน และภาพจาก 15 โรงเรียนในเครือมูลนิธิคณะเซนต์คาเบรียลแห่งประเทศไทย ขับเคลื่อนด้วยระบบ SWIS">
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                ...
                <p class="hero-desc">
                    ศูนย์กลางข่าวสาร ภาพกิจกรรม และปฏิทินจาก 15 โรงเรียนในเครือฯ ทั่วประเทศ
    ...
    <section id="news" class="section">
        <div class="container">
            <div class="section-header">
                ...
                <p>อัพเดทกิจกรรมและข่าวสารล่าสุดจาก 15 โรงเรียนทั่วประเทศ</p>
            </div>
    ...
    <section id="schools" class="section alt">
        <div class="container">
            <div class="section-header">
                ...
                <h2>15 โรงเรียน ทั่วประเทศไทย</h2>
            </div>
